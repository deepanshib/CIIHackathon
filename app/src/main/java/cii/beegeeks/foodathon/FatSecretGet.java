...
public class FatSecretGet {
    ...
    final static private String APP_KEY = "181567dcc3bd4d84b2b2d6727be03e75";
    final static private String APP_SECRET = "0bcfeb0982fe4d52aad420b5d03ad737&";
    ...
    public JSONObject getFood(Long ab) {
        ...
        try {
            ...
            food = foodGet.getJSONObject("foods");
        } catch (Exception e) {
